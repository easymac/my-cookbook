...
export function Logo() {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 199.23 134.95" className={styles.logo}>
      <defs>
        <style>
          {`
            .cover { fill: ${coverColor}; }
            .pages { fill: var(--primary-background); }
            .edges { fill: var(--primary-text); }
            .logo-text {
              font-family: var(--bagnard);
      ...
      <text 
        ...
        textAnchor="middle" 
        fontSize="70"
        transform="matrix(0.6, 0.30, -0.65, 0.35, 14, 14)"
      >
        {character}
      </text>
    </svg>
